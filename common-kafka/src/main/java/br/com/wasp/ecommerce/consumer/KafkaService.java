...
import br.com.wasp.ecommerce.dispatcher.GsonSerializer;
...
public class KafkaService<T> implements Closeable {
    ...
    private Properties getProperties(String groupId, Map<String, String> overrideProperties) {
        ...
        properties.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "1"); // 1 message at a time
        properties.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest"); // oldest messages available
